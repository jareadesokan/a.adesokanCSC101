...
fn main() {
    ...
    println!("How many staff were interviewed:");
    ...
    for _ in 1..number+1{
        ...
        println!("How many years of work experience does the staff have?:  ");
        io::stdin().read_line(&mut input2).expect("Not a valid input");
        let years_experience:i32 = input2.trim().parse().expect("Invalid Syntax.Please put an integer value.");
